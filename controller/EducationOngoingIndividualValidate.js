...
const educationOngoingIndividualValidate = Joi.object({
  ...
  health_status_of_mother: Joi.string().valid(
    'Chronically Sick',
    'HIV/AIDS positive',
    'Disabled',
    'Alcoholic',
  ...
  residential_status: Joi.string().valid('house owner', 'land owner', 'rented house', 'others').required(),
  ...
  other_support_received_from_other_sources: Joi.number().required(),
